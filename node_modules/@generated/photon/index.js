...
class Photon {
    constructor(options = { autoConnect: true }) {
        ...
        this.engine = new runtime_1.Engine({
            cwd: engineConfig.cwd || "/home/stephen/other/photon-sandbox/prisma/",
            debug: debugEngine,
            datamodel,
